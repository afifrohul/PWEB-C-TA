    ...
    <div class="card">
        ...
        <table class="table table-flush" id="datatable-buttons">
            ...
            <tr>
                ...
                <td>
                    <div class="row">
                        <form method="POST" class="inline mr-2" action="{{ url('back-doctor/drugOut/edit',$item->id) }}">
                            @csrf
                            <button class="btn btn-icon btn-primary" type="submit">
                                <span class="btn-inner--icon"><i class="fa fa-pen"></i></span>
                            </button>
                        </form>
                        <form method="POST" class="inline" action="{{ url('back-doctor/drugOut/destroy',$item->id) }}">
                            @method('delete')
                            @csrf
